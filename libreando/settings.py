...
"""
Django settings for libreando project.
...
if os.environ.get('ALLOWED_HOSTS'):
    ...
    ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'libreando.onrender.com']
...
WSGI_APPLICATION = 'libreando.wsgi.application'
...
# Allow CORS for localhost and 127.0.0.1 (all ports)
